  ...
  const handleSubmit = async () => {
    ...
    try {
      if (isEditMode && existingReview) {
        ...
        const removedImages =
          existingReview.images?.filter((url) => !selectedImages.includes(url)) || [];
        ...
        <View style={styles.content}>
          ...
          <View style={styles.ratingSection}>
            ...
            <View style={styles.ratingContainer}>
              <StarRating rating={rating} size={36} interactive={true} onRatingChange={setRating} />
          ...
          <View style={styles.photoSection}>
            ...
            <Text style={styles.photoSubtitle}>Photos help others learn about your experience</Text>
            ...
            {selectedImages.length > 0 && (
              <Text style={styles.photoCount}>{selectedImages.length} of 5 photos</Text>
            )}
          </View>
